...
GAME_BINARY = "SusShooter"
GAME_VERSION = "0.0.1"

PROGRAM_INFO = -DMVERSION=$(GAME_VERSION) -DMTITLE="$(GAME_TITLE)"

BUILD_OPTIONS = -g3 -Wpedantic -Ivendor/include/ -D_DEBUG
RELEASE_OPTIONS = -O2 -Wpedantic -Ivendor/include/ -D_BUILD_MAC_APP
...
build_win:
	$(COMPILER) $(BUILD_OPTIONS) $(CFILES) $(WIN_OUT) $(WIN_OPT)
